        ...
        <header className="sticky top-0 z-50 w-full glass-card px-4 h-20 flex flex-col justify-center border-b border-white/5">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3 cursor-pointer" onClick={() => navigate('/')}>
                    <div className="w-10 h-10 rounded-2xl bg-blue-600 flex items-center justify-center shadow-xl shadow-blue-600/30">
                        <span className="font-black text-white text-xl italic">F</span>
                    </div>
                    <div>
                        ...
                        <p className="text-[8px] font-black text-slate-500 uppercase tracking-[0.3em] mt-1">Strategic Operations</p>
                    </div>
                </div>
